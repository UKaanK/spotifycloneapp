...
import 'package:spotifycloneapp/presentation/song_player/bloc/song_player_cubit.dart';
import 'package:spotifycloneapp/presentation/song_player/bloc/song_player_state.dart';
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          image: DecorationImage(
              fit: BoxFit.cover,
              image: NetworkImage(
                  '${AppURLs.firestorage}${songEntity.artist.toLowerCase()}.jpg?${AppURLs.mediaAlt}'))),
    );
  }
